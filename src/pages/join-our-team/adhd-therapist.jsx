...
export default function ADHDTherapistJob() {
  ...
  return (
    <div className="p-8 max-w-3xl mx-auto">
      ...
      <h3 className="text-xl  text-sky-700 mt-8 mb-2">Job Type</h3>
      <ul className="list-disc list-outside text-gray-700 mb-6 space-y-1">
      ...
      <h3 className="text-xl  text-sky-700 mt-8 mb-2">Salary Range</h3>
      <ul className="list-disc list-outside text-gray-700 mb-6 space-y-1">
      ...
      <h3 className="text-xl  text-sky-700 mt-8 mb-2">Responsibilities</h3>
      <ul className="list-disc list-outside text-gray-700 mb-6 space-y-1">
      ...
      <h3 className="text-xl  text-sky-700 mt-8 mb-2">Minimum Requirements</h3>
      <ul className="list-disc list-outside text-gray-700 mb-6 space-y-1">
      ...
      <h3 className="text-xl  text-sky-700 mt-8 mb-2">Preferred</h3>
      <ul className="list-disc list-outside text-gray-700 mb-6 space-y-1">
