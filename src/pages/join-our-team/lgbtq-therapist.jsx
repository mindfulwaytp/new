...
export default function LGBTQTherapistJob() {
  ...
  return (
    <div className="p-8 max-w-3xl mx-auto">
      ...
      <h3 className="text-xl text-center font-extrabold text-sky-700 mt-8 mb-2">Our Mission</h3>
      ...
      <h3 className="text-xl text-center font-extrabold text-sky-700 mt-8 mb-2">Description</h3>
      <p className="text-gray-700 mb-6">
      ...
      <ul className="list-disc list-outside text-gray-700 mb-6 space-y-1">
      ...
      <h3 className="text-xl font-semibold text-sky-700 mt-6 mb-1">Position Hours</h3>
      <ul className="list-disc list-outside text-gray-700 mb-6 space-y-1">
        <li>Part-time: minimum 12 clients per week (scheduling 15)</li>
        <li>Full-time: minimum 22 clients per week (scheduling 25)</li>
      </ul>

      <h3 className="text-xl font-semibold text-sky-700 mt-6 mb-1">Location</h3>
      <ul className="list-disc list-outside text-gray-700 mb-6 space-y-1">
        <li className="italic">Remote/Hybrid to start with the possibility of in-person in the future</li>
      </ul>

      <h3 className="text-xl font-semibold text-sky-700 mt-8 mb-1">Salary Range</h3>
      <ul className="list-disc list-outside text-gray-700 mb-6 space-y-1">
      ...
      <h3 className="text-xl font-semibold text-sky-700 mt-6 mb-1">Responsibilities</h3>
      <ul className="list-disc list-outside text-gray-700 mb-6 space-y-1">
      ...
      <h3 className="text-xl font-semibold text-sky-700 mt-6 mb-1">Minimum Requirements</h3>
      <ul className="list-disc list-outside text-gray-700 mb-6 space-y-1">
      ...
      <h3 className="text-xl font-semibold text-sky-700 mt-6 mb-1">Preferred</h3>
      <ul className="list-disc list-outside text-gray-700 mb-6 space-y-1">
