...
export default function LGBTQTherapistJob() {
  ...
  return (
    <div className="p-8 max-w-3xl mx-auto">
      ...
      <h1 className="text-3xl  text-sky-800 mb-4">
        LGBTQ+ Affirming Therapist
      </h1>

      <h3 className="text-xl text-center  text-sky-700 mt-8 mb-2">Our Mission</h3>
      ...
      <h3 className="text-xl text-center  text-sky-700 mt-8 mb-2">Description</h3>
      <p className="text-gray-700 mb-6">
      ...
      <h3 className="text-xl  text-sky-700 mt-6 mb-1">Responsibilities</h3>
      <ul className="list-disc list-outside text-gray-700 mb-6 space-y-1">
      ...
      <h3 className="text-xl  text-sky-700 mt-6 mb-1">Minimum Requirements</h3>
      <ul className="list-disc list-outside text-gray-700 mb-6 space-y-1">
      ...
      <h3 className="text-xl  text-sky-700 mt-6 mb-1">Preferred</h3>
      <ul className="list-disc list-outside text-gray-700 mb-6 space-y-1">
